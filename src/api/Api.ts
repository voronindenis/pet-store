...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  pet = {
     ...
     */
    addPet: (data: IPet, params: RequestParams = {}) =>
      this.request<IPet, void>({
        path: `/pet`,
        method: 'POST',
        body: data,
     ...
     * @secure
     * @response `200` `IApiResponse` successful operation
     */
    uploadFile: (
      petId: number,
      data: File,
  ...
  store = {
     ...
     * @response `200` `IOrder` successful operation
     * @response `405` `void` Invalid input
     */
    placeOrder: (data: IOrder, params: RequestParams = {}) =>
      this.request<IOrder, void>({
        path: `/store/order`,
        method: 'POST',
        body: data,
        type: ContentType.Json,
  ...
  user = {
     ...
     * @summary Create user
     * @request POST:/user
     * @response `default` `IUser` successful operation
     */
    createUser: (data: IUser, params: RequestParams = {}) =>
      this.request<any, IUser>({
        path: `/user`,
        method: 'POST',
        body: data,
        type: ContentType.Json,
     ...
     * @response `200` `IUser` Successful operation
     * @response `default` `void` successful operation
     */
    createUsersWithListInput: (data: IUser[], params: RequestParams = {}) =>
     ...
     * @response `default` `void` successful operation
     */
    updateUser: (username: string, data: IUser, params: RequestParams = {}) =>
      this.request<any, void>({
        path: `/user/${username}`,
        method: 'PUT',
        body: data,
